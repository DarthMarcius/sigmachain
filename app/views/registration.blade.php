		...
		<div class="row">
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-10">
						<h3 id="chain-description" class="text-info text-center">Find your partners and suppliers faster with SigmaChain.</h3>
			...
			<div class="col-md-5">
				...
				<form action="/register" method="POST" class="form-horizontal" role="form" id="main-registration-form">
					...
					<div class="form-group">
						<label for="country-name-input" class="col-sm-4 control-label">
							Residence Country
						</label>
						<div class="col-sm-8">
