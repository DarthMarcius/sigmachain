<!-- js placed at the end of the document so the pages load faster -->
    ...
    <script class="include" type="text/javascript" src="../bootstrap/assets/js/jquery.dcjqaccordion.2.7.js"></script>
    <script src="../bootstrap/assets/js/jquery.scrollTo.min.js"></script>
    <script src="../bootstrap/assets/js/jquery.nicescroll.js" type="text/javascript"></script>
	...
	<script type="text/javascript" src="../bootstrap/assets/js/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js"></script>
	<script type="text/javascript" src="../bootstrap/assets/js/bootstrap-daterangepicker/moment.min.js"></script>
	<script type="text/javascript" src="../bootstrap/assets/js/bootstrap-timepicker/js/bootstrap-timepicker.js"></script>
